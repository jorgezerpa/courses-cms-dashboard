...
const CreateSection = () => {
    ...
    const {isError, isLoading, isSuccess, fireUp, restartFetch} = useFetchDataOnTrigger('POST', routes.createSection(router.query.courseId as string))
  ...
  return (
    <div className='p-5'>
        ...
        />
        <h3 className="text-2xl my-3 mb-10 font-medium text-gray-800 dark:text-white">Crear Nueva Sección</h3>
        <form ref={formRef} className="w-full max-w-lg" onSubmit={handleSubmit}>
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <input name="name" disabled={isSuccess || isLoading} className="disabled:opacity-50 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Mi sección" />
                </div>
            </div>
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <textarea name="description" disabled={isSuccess || isLoading} className="disabled:opacity-50 appearance-none block w-full min-h-[100px] bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" placeholder="Mi descripción" />
...
export default withPageAuthRequired(CreateSection)
